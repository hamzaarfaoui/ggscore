...
class __TwigTemplate_5dac746632b41bd793669436e9b8eeb72f7b02bc4650084ec3c80f2539fd2b5f extends \Twig\Template
{
    ...
    ";
        // line 4
        $context["lastPost"] = twig_last($this->env, ($context["posts"] ?? $this->getContext($context, "posts")));
        // line 5
        echo "    <div>
        ...
        echo twig_escape_filter($this->env, $this->getAttribute(($context["lastPost"] ?? $this->getContext($context, "lastPost")), "image", []), "html", null, true);
        echo "\" alt=\"\">
            <div class=\"uk-overlay uk-overlay-primary uk-position-bottom txt-img-post\">
                <p>";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute(($context["lastPost"] ?? $this->getContext($context, "lastPost")), "title", []), "html", null, true);
        echo "</p>
            </div>
        </div>
...
";
    ...
    {
        return array (  76 => 10,  70 => 8,  65 => 5,  63 => 4,  60 => 3,  51 => 2,  29 => 1,);
    }
...
{% block body %}
    ...
    <div>
        ...
        <div class=\"uk-inline\">
            <img src=\"{{ asset('uploads/articles/') }}{{ lastPost.image }}\" alt=\"\">
            <div class=\"uk-overlay uk-overlay-primary uk-position-bottom txt-img-post\">
                <p>{{ lastPost.title }}</p>
            </div>
        </div>
