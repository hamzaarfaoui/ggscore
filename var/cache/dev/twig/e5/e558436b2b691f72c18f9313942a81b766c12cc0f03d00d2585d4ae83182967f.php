...
class __TwigTemplate_f97643d5b003aeeda09f9679a045b6e5648149fe93d09a802ecc3dbb3a8346d9 extends \Twig\Template
{
...
<form action=\"";
    ...
    ";
        ...
        echo "</label>
        <input class=\"uk-input\" type=\"text\" id=\"username\" name=\"_username\" value=\"";
        // line 13
    ...
    <div class=\"uk-margin\">
        ...
        echo "</label>
        <input class=\"uk-input\" type=\"password\" id=\"password\" name=\"_password\" required=\"required\" autocomplete=\"current-password\" />
    </div>
    <div class=\"uk-margin\">
        <input class=\"uk-checkbox\" type=\"checkbox\" id=\"remember_me\" name=\"_remember_me\" value=\"on\" />
    ...
    <div class=\"uk-margin\">
        <input class=\"uk-button uk-button-primary\" type=\"submit\" id=\"_submit\" name=\"_submit\" value=\"";
        // line 24
...
<form action=\"{{ path(\"fos_user_security_check\") }}\" method=\"post\">
    ...
    <div class=\"uk-margin\">
        ...
        <input class=\"uk-input\" type=\"text\" id=\"username\" name=\"_username\" value=\"{{ last_username }}\" required=\"required\" autocomplete=\"username\" />
    </div>
    <div class=\"uk-margin\">
    ...
    <div class=\"uk-margin\">
        <input class=\"uk-button uk-button-primary\" type=\"submit\" id=\"_submit\" name=\"_submit\" value=\"{{ 'security.login.submit'|trans }}\" />
    </div>
</form>
", "FOSUserBundle:Security:login_content.html.twig", "/var/www/html/ggscore/app/Resources/FOSUserBundle/views/Security/login_content.html.twig");
    }
}
