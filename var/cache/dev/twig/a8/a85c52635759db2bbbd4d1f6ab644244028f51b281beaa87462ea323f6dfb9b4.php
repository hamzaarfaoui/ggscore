...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "SwiftmailerBundle:Collector:swiftmailer.html.twig", "/var/www/html/ggscore/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig");
    }
}
