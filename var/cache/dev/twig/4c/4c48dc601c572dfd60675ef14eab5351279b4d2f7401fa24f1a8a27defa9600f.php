...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "SecurityBundle:Collector:security.html.twig", "/var/www/html/ggscore/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views/Collector/security.html.twig");
    }
}
